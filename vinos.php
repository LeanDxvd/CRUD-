            ...
            <main class="main col">
                <div class="row justify-content-center align-content-center text-center">
                    ...
                    ?>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                <th scope="row"><?php echo $fila['idVinos']; ?></th>
                                <td><img width="65" height="75" src="<?php echo "img/vino.jpg".$fila['Foto'];?>"></td>
                                <td> <?php echo $fila['NomVinos']; ?></td>
                                <td><?php echo $fila['CantVinos'];?></td>
                                <td><?php echo $fila['LoteVinos'];?></td>
                               
                                <td>
                                <a href="editarvinos.php? id=<?php echo $fila['idVinos'];?>" class="btn btn-success">Editar</a>
                                </td>
                            
                               
                                <td>
                                <a href="eliminarvino.php? id=<?php echo $fila['idVinos'];?>" class="btn btn-danger">Eliminar</a>
                            </td>
                                </tr>
                            <?php
                            endforeach
                    ...
                    <div class="card-header">
                            ...
                            <form  class="p-4" method="POST" action="registrarvino.php">
                                <div class="mb-3">
